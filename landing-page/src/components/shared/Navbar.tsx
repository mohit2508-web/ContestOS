    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-white tracking-tight text-lg">Kryptavia OS</span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-5 text-sm text-gray-400">
          ...
          <a
            ...
            className="px-5 py-2 bg-white/10 hover:bg-white/15 rounded-full text-white transition-colors text-sm font-medium border border-white/10 text-center"
          >
            Sign In
          </a>
        </div>
